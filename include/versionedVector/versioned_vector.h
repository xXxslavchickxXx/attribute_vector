...
/// <summary>
/// Эта обертка над стд_вектором с версионированием это не панацея!!!!!
/// 
/// Я не заставляю пользователя использовать ее, вы также можете
/// написать свои аллокаторы отслеживающие изменения.
/// А так да, эта обертка не производительна для больших данных
/// и в записи она дорога, но часто ли данные меняются внутри больших данных?
/// Собственно ради вариативности я и позволяю пользователю использовать
/// любые виды векторов, точнее даю доступ выбора как шаблон attribute_vector
/// </summary>
namespace versions {
    class Versioned {
